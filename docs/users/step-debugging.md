...
2. Update the project's launch.json ([.vscode/launch.json](https://code.visualstudio.com/docs/editor/debugging#_launch-configurations)) to add "Listen for xdebug" (see [config snippet](snippets/launch.json))
